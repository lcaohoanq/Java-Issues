...
//JCheckBoxMenuItem: nhieu lua chon, nhieu lua chon duoc chon
//JRadioButtonMenuItem: nhieu lua chon, chi 1 lua chon duoc chon
public class MenuView extends JFrame {
  ...
  JMenu menuFile;
  JMenu menuView;
  JCheckBoxMenuItem jCheckBoxMenuItem_toolbar;
  JMenu menuHelp;
  JMenuItem menuNew;
  JMenuItem menuOpen;
  JMenuItem menuExit;
...
//    menuBar.setLocation(0, 0);
    ...
    jCheckBoxMenuItem_toolbar = new JCheckBoxMenuItem("Show Toolbar");

    menuView.add(jCheckBoxMenuItem_toolbar);
...
//    panel.add(menuBar, BorderLayout.NORTH);
    ...
    jToolBar.setVisible(false); //an di
