          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
              <a href="https://accounts.google.com/o/oauth2/auth?scope=email 
                 profile 
                 openid&redirect_uri=http://localhost:8080/MyShop/login&response_type=code&client_id=57725428107-3ppj4bcq83ls8b7jlojbka02glmhn4ed.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
